...
def notification():
    if request.method == 'POST':
        ...
        try:
            ...
            logging.info('Python ServiceBus queue trigger processed message: %s',str(notification_id))
            msg = Message(str(notification_id))
            queue_client.send(msg)
            
            #logging.info('Python ServiceBus queue trigger processed message: %s',notification.id)
